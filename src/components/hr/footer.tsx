...
const CONTENT = {
  hr: {
    tagline: "Digitalna turistička agencija za Split i Dalmaciju",
    ...
    copyright: "\u00a9 2026 Opsis Dalmatia. Sva prava pridr\u017eana.",
  },
  en: {
    tagline: "Digital tourist agency for Split and Dalmatia",
    ...
    copyright: "\u00a9 2026 Opsis Dalmatia. All rights reserved.",
  },
};
    ...
    <footer className="bg-zinc-950 border-t border-zinc-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800">
          <p className="text-center text-sm text-zinc-500">{t.copyright}</p>
        </div>
      </div>
    </footer>
  );
